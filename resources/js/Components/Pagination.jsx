            ...
            <nav aria-label="Page navigation w-full">
                <ul className="flex items-center -space-x-px h-8 text-sm min-w-full">
                    <li className={`pagination-item ${blogPosts.current_page === 1 ? 'disabled' : ''}`}>
                        <a className="flex items-center justify-center px-3 h-8 ml-0 leading-tight text-gray-500  border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white" href={`${path}/?page=1`} aria-label="PageFirst">
                             First
                        </a>
                    </li>
